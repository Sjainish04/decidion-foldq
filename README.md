...
**Where the evidence is.** [`results/full/`](results/full) — 1,008 rows of
committed CSV, regenerated by `make reproduce`, with a manifest pinning commit,
Python version, platform and seed. Every number below traces to it.
